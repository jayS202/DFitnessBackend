...
SECRET_KEY = 'django-insecure-gb_1^y1kky_$44vlua#ox0%zurhk==_7fh-^^o)2a+6x(tp=fc'
...
MIDDLEWARE = [
    ...
    'fitproject.middleware.FirebaseAuthMiddleware',
...
WSGI_APPLICATION = 'fitaccount.wsgi.application'
